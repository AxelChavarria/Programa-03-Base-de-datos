DECLARE @XMLSimulacion XML;

-- 1. Definimos el XML completo envuelto en <Operaciones>
SET @XMLSimulacion = '
...
'
-- 2. Ejecutamos el procedimiento maestro encargado de orquestar la simulación
...
/*
-- 1. Desactivar temporalmente restricciones si es necesario, o borrar en orden jerárquico
DELETE FROM dbo.BitacoraEvento WHERE idTipoEvento IN (5, 7, 8);
DELETE FROM dbo.DBError;
DELETE FROM dbo.Asistencia;
DELETE FROM dbo.CalendarioJornadaEmpleado;
DELETE FROM dbo.DeduccionXEmpleado;

-- 2. Limpiar planillas si se generó algo a medias
-- DELETE FROM dbo.PlanillaSemXEmpleado; 
-- DELETE FROM dbo.PlanillaMesXEmpleado;

-- 3. Borrar empleados y usuarios creados por la simulación
DELETE FROM dbo.Empleado;
DELETE FROM dbo.Usuario WHERE Id > 1; -- Deja solo el administrador original si tenías uno

-- 4. REINICIAR EL TIEMPO (Crucial)
...
DELETE FROM DeduccionSemanalXEmpleado

-- 5. Insertar los contenedores de tiempo iniciales limpios para que calcen con el XML (05 de Marzo)
INSERT INTO dbo.MesPlanilla (FechaInicio, FechaFin, EsCerrado) 
VALUES ('2026-03-01', '2026-03-31', 0);

INSERT INTO dbo.SemanaPlanilla (IdMesPlanilla, FechaInicio, FechaFin, CantidadJuevesMes, EsCerrado)
VALUES ((SELECT MAX(Id) FROM dbo.MesPlanilla), '2026-03-05', '2026-03-11', 4, 0);
*/